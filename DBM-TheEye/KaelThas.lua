...
local timerGravity          = mod:NewTimer(32.5, "TimerGravity", "Interface\\Icons\\Spell_Magic_FeatherFall", nil, nil, 4, nil, DBM_CORE_HEALER_ICON, nil, 2, 5)
local timerGravityCD        = mod:NewCDTimer(90, 35941, nil, nil, nil, 4, nil, DBM_CORE_HEALER_ICON, nil, 2, 4)
...
local specWarnBattleRoar  = mod:NewSpecialWarning("specWarnBattleRoar", canInterrupt)
...
local timerGravityH     = mod:NewTimer(63, "TimerGravity", "Interface\\Icons\\Spell_Magic_FeatherFall", nil, nil, 6, nil, DBM_CORE_HEALER_ICON)
local timerGravityHCD   = mod:NewCDTimer(150, 35941, nil, nil, nil, 6, nil, DBM_CORE_HEALER_ICON)
...
local yellBombhm	   = mod:NewYell(308750)
