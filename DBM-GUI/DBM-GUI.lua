...
local function CreateOptionsMenu()
	...
	do
		...
		local textbox = pizzaarea:CreateEditBox(L.PizzaTimer_Title, "Тунга прошляпил очко!", 175)
...
--			{sound = true, text = "Yogg Saron: Laugh", value = 15757},
	...
	do
		...
		local dualProfileArea		= profilePanel:CreateArea(L.Area_DualProfile, nil, 70, true)
