...
DBM_CORE_YOUR_VERSION_OUTDATED      = "ВНИМАНИЕ! Ваша версия DBM устарела! Пожалуйста, посетите " .. DBM_CORE_UPDATEREMINDER_URL .. " для загрузки последней версии."
...
DBM_CORE_UPDATEREMINDER_HEADER			= "Ваша версия DBM устарела.\n Версия %s (r%d) доступна для загрузки здесь:"
...
DBM_CORE_UPDATEREMINDER_DISABLE			= "ПРЕДУПРЕЖДЕНИЕ: В связи с тем, что Ваш DBM сильно устарел, он был отключен до обновления. Это сделано для того, чтобы старый и несовместимый код не вызывал плохой игровой опыт для Вас и других членов рейда."
