...
local timerLunaricGaze				= mod:NewCastTimer(4, 313027)
local timerNextLunaricGaze			= mod:NewCDTimer(8.5, 313027)
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(64059, 312650, 313003) then	-- Induce Madness
		timerMadness:Start()
		warnMadness:Show()
	...
	elseif args:IsSpellID(64189, 312647, 313000) then		--Deafening Roar
		timerNextDeafeningRoar:Start()
		warnDeafeningRoarSoon:Schedule(55)
		timerCastDeafeningRoar:Start()
		specWarnDeafeningRoar:Show()
	elseif args:IsSpellID(63138, 312636, 312989) then		--Sara's Fervor
...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(63802, 312641, 312994) then		-- Brain Link
	...
	elseif args:IsSpellID(63830, 63881, 312640, 312993) then   -- Malady of the Mind (Death Coil) 
	...
	elseif args:IsSpellID(64126, 64125, 312678, 313031) then	-- Squeeze		
	...
	elseif args:IsSpellID(64167, 64163, 312648, 312674, 313001, 313027) then	-- Lunatic Gaze (reduces sanity)
...
function mod:SPELL_AURA_REMOVED(args)
	...
	elseif args:IsSpellID(64167, 64163, 312648, 312674, 313001, 313027) then	-- Lunatic Gaze
