...
local timerP3toP4				= mod:NewTimer(49, "TimeToPhase4")
...
function mod:SPELL_CAST_SUCCESS(args)
	if args:IsSpellID(63027, 312436, 312789) then				-- mines
...
function mod:NextPhase()
	...
	elseif phase == 2 then
		...
		timerP1toP2:Start()
        timerVolleyCD:Schedule(50)
        timerVolleyCD:Schedule(88)
        timerVolleyCD:Schedule(113)
        timerVolleyCD:Schedule(152)
        timerVolleyCD:Schedule(174)
        timerVolleyCD:Schedule(211)		
	...
	elseif phase == 4 then
		...
		timerP3toP4:Start()
		timerDarkGlareCast:Schedule(44)
		timerVolleyCD:Schedule(49)
        timerVolleyCD:Schedule(88)
        timerVolleyCD:Schedule(111)
