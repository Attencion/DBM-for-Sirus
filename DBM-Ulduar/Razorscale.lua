...
local warnArmorfire		            = mod:NewStackAnnounce(312721, 4)
...
local timerDeepBreathCooldown		= mod:NewCDTimer(15, 313098)
local timerDeepBreathCast			= mod:NewCastTimer(2.5, 313098)
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(313098) then	-- deep breath
