...
L:SetOptionLocalization{
        DevouringFlameIcon		= "Устанавливать метки на цели заклинания $spell:64733",
...
L:SetOptionLocalization{
	...
	SetIconOnLightBombTarget	= DBM_CORE_AUTO_ICONS_OPTION_TEXT:format(312588),
...
L:SetWarningLocalization{
        WarningCrunchArmor	= "Хруст доспеха на |3-5(>%s<) - cтак %d"
}
...
L:SetOptionLocalization{
        WarningCrunchArmor		= "Объявлять цели заклинания $spell:312748",
...
L:SetWarningLocalization{
	SpecWarnBlast	= "Удар часового - ПРЕРВИТЕ",
...
L:SetTimerLocalization{
        TimerSpeedKill	= "До прекрасной Слойки",
...
L:SetMiscLocalization{
        YellDeathCoil		        = "Душевная болезнь на мне! ОТОЙДИТЕ!",
...
L:SetWarningLocalization{
	...
	WarnBrainPortalSoon		= "Провал Безумия через 5 секунды",	
...
L:SetOptionLocalization{
        WarnPhase2Soon			= "Предупреждать заранее о фазе 2",
        WarnPhase3Soon			= "Предупреждать заранее о фазе 3 ( на 35% )",
        RangeFrame		        = "Показывать игроков в окне проверки дистанции(12)",
        YellOnDeathCoil	                = "Кричать, когда на вас $spell:312993",
	...
	WarningSqueeze			= "Кричать, когда на вас $spell:313031",
	...
	SetIconOnFervorTarget		= "Устанавливать метки на цели заклинания $spell:312989",
        SetIconOnBeacon		        = "Устанавливать метки на цели заклинания $spell:64465",
