...
local warnStormCloud		= mod:NewTargetAnnounce(312831)
...
local timerFrozenBlows		= mod:NewBuffActiveTimer(20, 312462)
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(61968, 312465, 312818) then
...
function mod:SPELL_AURA_APPLIED(args)
	if args:IsSpellID(62478, 63512, 312815, 312462) then
		timerFrozenBlows:Start()
	elseif args:IsSpellID(65123, 65133, 312478, 312831) then
...
do 
	...
	function mod:SPELL_DAMAGE(args)
		if args:IsSpellID(62038, 62188, 312466, 312819) and args:IsPlayer() and time() - lastbitingcold > 4 then		-- Biting Cold
