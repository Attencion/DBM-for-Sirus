...
local warnBoneSpike		= mod:NewCastAnnounce(69057, 2)  -- шип
...
local timerBoneSpike		= mod:NewCDTimer(17, 69057, nil, nil, nil, 1, nil, DBM_CORE_DAMAGE_ICON)  -- шип
local timerWhirlwindCD		= mod:NewCDTimer(95, 69076, nil, nil, nil, 2, nil, DBM_CORE_HEROIC_ICON)  -- вихрь
