...
L:SetWarningLocalization{
	specWarnFrostbolt	        = "Ледяная стрела - ПРЕРВИТЕ",
...
L:SetOptionLocalization{
	specWarnFrostbolt	        = "Спец-предупреждение об $spell:72007 (для прерывания)",
...
L:SetMiscLocalization{
	...
	AddsHorde	= "Солдаты, сержанты, в бой!"
}
...
L:SetOptionLocalization{
	...
	SpecWarnValkyrLow		= "Спец-предупреждение, когда у Валь'киры меньше 60% ХП"
}

L:SetMiscLocalization{
	LKPull			= "Неужели прибыли наконец хваленые силы Света? Мне бросить Ледяную Скорбь и сдаться на твою милость, Фордринг?",
	YellCombatEnd	        = "СВЕТ, ДАРУЙ МНЕ ПОСЛЕДНЕЕ БЛАГОСЛОВЕНИЕ! ДАЙ МНЕ СИЛУ... РАЗБИТЬ ЭТИ ОКОВЫ!",
	YellDefile		= "Осквернение на мне!",
	YellTrap		= "Прошляпанное очко Тунги на мне!",
